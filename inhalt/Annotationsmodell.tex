...
Die getrennte Führung beider Informationen im internen Modell ist durch den IFC Standart bedingt: 
IFC unterscheidet dieselben beiden Aussagen durch verschiedene Beziehungsobjekte: Die 
...
aufgebaut ist.
\#TODO 
inwieweit wird die zeitliche Steuerung durch ROS unterstützt? Wenn z.B. eine Task eine Deadline hat, muss sich das Programm darum kümmern diese einzuhalten oder kann das die Plattform sicherstellen?
-> die Deadline einer Task ist eine Optimierungs Richtschnur für das System. Der Roboter könnte aufgrund der Gesamtdauer aller Tasks Wartezeiten verkürzen.
Er erhält dadurch einen Erwartungshorizont.
