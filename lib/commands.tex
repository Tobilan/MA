...
\thispagestyle{empty}
\includegraphics[scale=0.2]{pics/oth-logo.png}\ifthenelse{\equal{#1}{}}{}{\hfill\includegraphics[scale=0.5]{#1}}
\begin{center}
\ifthenelse{\equal{#2}{2}}{ % then
	...
	\ifthenelse{\equal{#3}{Bachelorarbeit}}{Bachelor of Science (B.Sc.)}{Master of Engineering (M.Eng.)}\\
	\vspace*{1cm}
	\Large
	\textbf{#4}\\
}{ % else
